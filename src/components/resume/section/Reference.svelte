    ...
    <div class="resume-section-content">
        <ul class="list-unstyled resume-awards-list">
            <li class="mb-2 ps-4 position-relative">
                ...
                <div class="resume-award-desc mt-1">
                    ICAART 2025 &mdash; Vol. 2, pp. 533–542 &middot; DOI: 10.5220/0013192300003890
                </div>
                <div class="resume-award-desc" style="font-style:italic; margin-top:2px;">
                    M. Rosano, D. Leocata, A. Furnari, G.M. Farinella
                </div>
            </li>
        </ul>
    </div>

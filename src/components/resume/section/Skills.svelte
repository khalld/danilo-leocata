<section class="resume-section skills-section mb-5">
    ...
    <div class="resume-section-content">
        ...
        <div class="resume-skill-item">
            <h4 class="resume-skills-cat font-weight-bold">Major Skills</h4>
            <ul class="list-inline mb-4">
                <li class="list-inline-item mb-1"><span class="badge badge-light">Java</span></li>
        ...
        <div class="resume-skill-item">
            <h4 class="resume-skills-cat font-weight-bold">Frontend &amp; Other (Amateur)</h4>
            <ul class="list-inline mb-4">
                <li class="list-inline-item mb-1"><span class="badge badge-light">Node.js</span></li>
                <li class="list-inline-item mb-1"><span class="badge badge-light">JavaScript</span></li>
                <li class="list-inline-item mb-1"><span class="badge badge-light">TypeScript</span></li>
                ...
                <li class="list-inline-item mb-1"><span class="badge badge-light">Bootstrap</span></li>
            </ul>
        </div>
        ...
        <div class="resume-skill-item">
            ...
            <ul class="list-inline">
                ...
                <li class="list-inline-item mb-1"><span class="badge badge-light">AWS</span></li>
            </ul>
        </div>
